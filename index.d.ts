...
declare namespace Mark {
    ...
    interface SetEventListenersCallbacks {
        onClick?(markId: string, event: MouseEvent): void 
        onMouseOver?(markId: string, event: MouseEvent): void 
        onMouseLeave?(markId: string, event: MouseEvent): void 
    }

    interface SetEventListenersOptions {
        element?: string | undefined;
        done?(marksTotal: number): void;
    }
...
declare class Mark {
    ...
    /**
     * A method to set event listeners for each mark.js node.
     * @param callbacks required callbacks map
     * @param options Optional options
     */
    setEventListeners(callbacks: Mark.SetEventListenersCallbacks, options?: Mark.SetEventListenersOptions): void;
}
